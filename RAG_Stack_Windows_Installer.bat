...
echo   1. HTTPS with self-signed certificate (local development)
echo   2. HTTPS with Let's Encrypt (requires domain + port 80)
echo.
echo Note: HTTP-only is not supported. Many services require HTTPS for webhooks.
echo.

:get_ssl_choice
set /p SSL_CHOICE="Choose option (1-2) [1]: "
